...
namespace HandballManager.Simulation.Engines
{
    public static class SimConstants
    {
        ...
        /// <summary>Radius within which a player can pick up a loose ball.</summary>
        ...
        // --- Player Collision ---
        /// <summary>Radius used for player collision detection (meters).</summary>
        public const float PLAYER_COLLISION_RADIUS = 0.4f;
        /// <summary>Diameter used for player collision detection (meters).</summary>
        public const float PLAYER_COLLISION_DIAMETER = PLAYER_COLLISION_RADIUS * 2f;
        /// <summary>Squared diameter for fast collision checks.</summary>
        ...
        // --- Pitch Dimensions ---
        /// <summary>Default pitch length in meters for handball court.</summary>
        public const float DEFAULT_PITCH_LENGTH = 40.0f;
        /// <summary>Default pitch width in meters for handball court.</summary>
